export default {
  ...
  template: /*html*/ `
      <div class="col">
        <div v-on:click="mutliSelectItem" class="card h-100 card-optional-component" v-bind:class="{ 'border-info': isMultiSelected, 'border-warning': deprecatedText && !isMultiSelected }">
          ...
          <div class="card-footer bg-transparent">
            <div class="d-grid gap-2 d-md-flex justify-content-md-between">
              ...
              <span v-if="isDeprecated" class="text-warning lh-lg">
